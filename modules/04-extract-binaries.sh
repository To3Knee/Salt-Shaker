...
#Version: 9.7
#Short: Extract onedir + overlay RPMs to vendor
#About: Extracts Salt onedir tarballs to vendor/<elX>/salt, overlays salt-ssh/salt RPM contents,
#About: supports --all/--dry-run/--tarball and SALT_SHAKER_DEFAULT_ALL env toggle; quiet console output
#About: (only OK/WARN/ERROR checkmarks), verbose timestamps remain in log files. Validates and prints a summary table.
#===============================================================
set -euo pipefail

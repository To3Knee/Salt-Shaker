...
#Version: 3.31
#Short: Verify Salt RPMs and onedir tarballs
#About: Verifies controller artifacts for EL7/EL8/EL9 and EL7 thin core.
#About: Optional thin extras/backports are INFO by default; use --strict
#About: to enforce them. EL7-safe (bash 4.2), no new dependencies.
#===============================================================
set -euo pipefail
